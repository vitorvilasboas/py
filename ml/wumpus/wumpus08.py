...
class Config:
    def __init__(self):
        ...
        self.taxaElitismo     = 0.95 # relacionado a qtd de melhores pais que permanecerão
        self.geracoes         = 1000
...
class AG:   
    ...
    def evaluateShooting(self, individuo, destinoTiro):
        if destinoTiro in self.amb.wumpus:
            # print('yes', destinoTiro, individuo.cromossomo)
    ...
    def __init__(self):
        ...
        print('f otimo: ',self.individuoOtimo.fitness)
