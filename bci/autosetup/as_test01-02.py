...
if __name__ == "__main__":
    ...
    for class_ids in [[3,4]]: # [1,2],[1,3],[1,4],[2,3],[2,4],[3,4]
        for suj in range(8, 9):
            for ex in range(1, 1001):
                print(f"Exec: {ex}")
                ch=range(0,22) 
                Fs=250
    ...
    # pd.to_pickle(A, 'G:/Meu Drive/devs/BCI/results/trials/resultado_A08_FT_1000.pkl') 
    # A.to_excel('G:/Meu Drive/devs/BCI/results/trials/resultado_A08_FT_1000.xlsx')
    pd.to_pickle(A, 'G:/Meu Drive/devs/BCI/results/trials/resultado_A08_FT_100.pkl')
