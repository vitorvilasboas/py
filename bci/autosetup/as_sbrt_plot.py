...
# path_to_fig = '/home/vboas/cloud/results/sbrt20/' + ds + scenario + '/fig/' # PATH TO AUTO SETUP RESULTS FIGURES
# if not os.path.isdir(path_to_fig): os.makedirs(path_to_fig)

R = pd.read_pickle('D:/devs/BCI/results/sbrt20/' + ds + scenario + '/A01_1x2.pkl') 
# R = pd.read_pickle('/home/vboas/cloud/results/sbrt20/' + ds + scenario + '/RESULTS.pkl')  
