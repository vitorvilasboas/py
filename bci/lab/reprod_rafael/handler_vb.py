...
def read_events(events_path):
    ...
    # t_events = np.insert(e, 1, values=0, axis=1) ### comment vboas (desnecessário, npy já estão preparados)
    # t_events = t_events.astype(int)  # convert to integer ### comment vboas (desnecessário, npy já estão preparados)
    # return t_events
    return e