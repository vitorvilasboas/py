...
dset = sio.loadmat('D:/OneDrive/BCI_tools/bcic3.4a/matlab/aa.mat')
...
labels = sio.loadmat('D:/OneDrive/BCI_tools/bcic3.4a/true_labels/trues_aa.mat')
classes_true = labels['true_y']
idxv = labels['test_idx'] #indices de validação
dset['mrk']['y'][0][0] = labels['true_y']

fileName = "D:/OneDrive/BCI_tools/bcic3.4a/aa.pickle"  # abre o arquivo para escrever
