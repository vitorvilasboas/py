...
if __name__ == "__main__":
    ...
    n_comp = 10 # componentes CSP (3 pares = 6)
    fs = 250
    Clog = -4
    ...
    for n_bandas in NBANDAS:
        for sujeito in sujeitos:
            ...
            for classes,cl in zip(pares_classes,range(len(pares_classes))):
                ...
                XT = list(load('/mnt/dados/datasets/eeg_epochs/BCI4_2a/A0' + str(sujeito) + 'T.npy'))
                XV = list(load('/mnt/dados/datasets/eeg_epochs/BCI4_2a/A0' + str(sujeito) + 'E.npy'))
                
                XT = ([XT[classes[0]-1], XT[classes[1]-1]])
                XV = ([XV[classes[0]-1], XV[classes[1]-1]])
...
#                    step -= 2 # default = 2 
                ...
                for i in range(n_bandas):
                    ...
                    XTSB.append(XTC[:, :, bin_ini:bin_fim])
                    XVSB.append(XVC[:, :, bin_ini:bin_fim])
                    nb.append(array([bin_ini/4,bin_fim/4])) # armazena freq_ini e freq_fim
