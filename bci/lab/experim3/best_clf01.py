...
if __name__ == '__main__':
    ...
    for classifier in classifiers:
        ...
        for suj in sujeitos:
            ...
            Z = np.concatenate([S1, S2]) # ...nesse caso: lh + rh
        ...
        # --------------------------------------- #
        ## ANÁLISE DOS RESULTADOS (cada classificador)
        # --------------------------------------- #
        ...
        fins_unicos = np.asarray(np.sort(list(set(WIN['Jfim'])))) # outra forma de extrair
