...
if __name__ == '__main__':
    ...
    for suj in sujeitos:
        ...
        Z = np.concatenate([S[0], S[3]]) # ...nesse caso: lh + rh
    ...
    # Gerado o coeficiente de correlação entre as dimensões e as taxas de classificações médias para cada dimensão possível
