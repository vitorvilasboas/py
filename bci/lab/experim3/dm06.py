...
if __name__ == '__main__':
    ...
    sumario_classificador = np.zeros((len(sujeitos),4)) #,5
    for s in range(len(sujeitos)):
        # sumario_classificador[s,0] = 100 + cont # representa o classificador (100=LDA, 106=KNN)
        sumario_classificador[s,0] = s+1 #s,1
        for j in range(3):
            sumario_classificador[s,j+1] = round(medias_acc_suj[s,j]*100,2) #j+2
    ...
    # 2.1. Plotagem única todos os sujeito (FIGURA 4)
    ...
    '''
    # 2.2. Plotagem separada por sujeito distribuidos em forma de matriz (FIGURA 5 OLD)
    ...
    '''
    '''
    # 2.3. Plotagem separada por sujeito distribuidos em forma de matriz (escala invertida)
    plt.figure(3, facecolor='mintcream')
    plt.subplots(figsize=(10, 6), facecolor='mintcream')
    for s in range(len(sujeitos)):
        plt.subplot(3,3,s+1)
    ...
    # 3.1. Plotagem única todos os sujeitos  (FIGURA 6)
    ...
    # 4.1. Plotagem separada por sujeito distribuidos em forma de matriz (FIGURA 10)
    ...
    # 5. Gráfico Principal - Boxplot representando as melhores janelas de cada sujeito (FIGURA 9)
    ...
    # 2.1. Plotagem separada por sujeito distribuidos em forma de matriz (FIGURA 5)
    modelo_regressao = LinearRegression()
    ...
    # 2.1. Plotagem separada por sujeito distribuidos em forma de matriz (FIGURA 7)
    modelo_regressao = LinearRegression()
    plt.figure(7, facecolor='mintcream')
    plt.subplots(figsize=(10, 6), facecolor='mintcream')
    for s in range(len(sujeitos)):
    ...
    ## GRÁFICO - Comparativo entre os modelos de classificação (FIGURA 2)
